/*
Скетч використовує 25008 байтів (81%) місця зберігання для програм. Межа 30720 байтів.
Глобальні змінні використовують 1414 байтів (69%) динамічної пам’яті,  залишаючи 634 байтів для локальних змінних. Межа 2048 байтів.
*/
